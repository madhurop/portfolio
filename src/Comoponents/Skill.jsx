  ...
  return (
    <div className="w-full min-h-screen full flex flex-col items-center">
        ...
        <div className="w-11/12  h-auto mt-4 text-white flex flex-auto flex-wrap gap-x-14 gap-y--5 justify-evenly ">
            <div className="w-2/12 h-2/6 flex flex-col items-center  ">
              <img className="w-11/12" src="https://img.icons8.com/color/480/html-5--v1.png" alt="" /><ReactTyped strings={["HTML"]} typeSpeed={40} /></div>
            <div className="w-2/12 h-2/6 flex flex-col items-center  ">
